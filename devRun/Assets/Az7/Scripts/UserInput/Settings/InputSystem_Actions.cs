...
//     version 1.18.0
//     from Assets/Az7/Scripts/UserInput/Settings/InputSystem_Actions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Az7/Scripts/UserInput/Settings/InputSystem_Actions.inputactions".
/// </summary>
/// <remarks>
...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""Branches"",
            ""id"": ""f5baabd6-3047-4046-a774-b3266bbc2896"",
            ""actions"": [
                {
                    ""name"": ""MoveLeft"",
                    ""type"": ""Button"",
                    ""id"": ""c6b85faa-faf5-4f51-8558-029affb2d58b"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""MoveRight"",
                    ""type"": ""Button"",
                    ""id"": ""bad023be-9c4e-46b2-bae7-5d2c359e45c7"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""Action"",
                    ""type"": ""Button"",
                    ""id"": ""0c27c2c4-a6a1-45ca-b5b1-13a0c3b4c4b4"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""acd49f87-f640-47eb-b479-4c6c168baded"",
                    ""path"": ""<Keyboard>/a"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""d490e18b-6309-4e34-bc3e-19902a4ef843"",
                    ""path"": ""<Keyboard>/leftArrow"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""91243c3e-2411-41e7-9a93-ccbf9ce99d83"",
                    ""path"": ""<Keyboard>/d"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""7adc913b-04cc-4de3-b4bc-99bcbd4ebbc7"",
                    ""path"": ""<Keyboard>/rightArrow"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""b6cb73b5-5a5d-41f6-9419-85dbde7edb4e"",
                    ""path"": ""<Keyboard>/space"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
                ...
                {
                    ""name"": """",
                    ""id"": ""9d3dbc8a-5a63-42bb-b6cb-fdaca9d46feb"",
                    ""path"": ""<Keyboard>/downArrow"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": "";Keyboard&Mouse"",
    ...
    ""controlSchemes"": [
        ...
        // Branches
        m_Branches = asset.FindActionMap("Branches", throwIfNotFound: true);
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_Branches.enabled, "This will cause a leak and performance issues, InputSystem_Actions.Branches.Disable() has not been called.");
    }
    ...
    // Branches
    private readonly InputActionMap m_Branches;
    private List<IBranchesActions> m_BranchesActionsCallbackInterfaces = new List<IBranchesActions>();
    ...
    public struct BranchesActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public BranchesActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Branches/MoveLeft".
        /// </summary>
        public InputAction @MoveLeft => m_Wrapper.m_Branches_MoveLeft;
        /// <summary>
        /// Provides access to the underlying input action "Branches/MoveRight".
        /// </summary>
        public InputAction @MoveRight => m_Wrapper.m_Branches_MoveRight;
        /// <summary>
        ...
        /// Provides access to the underlying input action map instance.
        /// </summary>
        public InputActionMap Get() { return m_Wrapper.m_Branches; }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Enable()" />
        public void Enable() { Get().Enable(); }
        /// <inheritdoc cref="UnityEngine.InputSystem.InputActionMap.Disable()" />
        public void Disable() { Get().Disable(); }
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="BranchesActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        public static implicit operator InputActionMap(BranchesActions set) { return set.Get(); }
        /// <summary>
        /// Adds <see cref="InputAction.started"/>, <see cref="InputAction.performed"/> and <see cref="InputAction.canceled"/> callbacks provided via <param cref="instance" /> on all input actions contained in this map.
        /// </summary>
        /// <param name="instance">Callback instance.</param>
        ...
        /// If <paramref name="instance" /> is <c>null</c> or <paramref name="instance"/> have already been added this method does nothing.
        /// </remarks>
        /// <seealso cref="BranchesActions" />
        public void AddCallbacks(IBranchesActions instance)
        {
            if (instance == null || m_Wrapper.m_BranchesActionsCallbackInterfaces.Contains(instance)) return;
            m_Wrapper.m_BranchesActionsCallbackInterfaces.Add(instance);
        ...
        /// </remarks>
        /// <seealso cref="BranchesActions" />
        private void UnregisterCallbacks(IBranchesActions instance)
        {
            @MoveLeft.started -= instance.OnMoveLeft;
            @MoveLeft.performed -= instance.OnMoveLeft;
            @MoveLeft.canceled -= instance.OnMoveLeft;
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="BranchesActions.UnregisterCallbacks(IBranchesActions)" />.
        /// </summary>
        /// <seealso cref="BranchesActions.UnregisterCallbacks(IBranchesActions)" />
        public void RemoveCallbacks(IBranchesActions instance)
        {
            if (m_Wrapper.m_BranchesActionsCallbackInterfaces.Remove(instance))
                UnregisterCallbacks(instance);
        }
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="BranchesActions.AddCallbacks(IBranchesActions)" />
        /// <seealso cref="BranchesActions.RemoveCallbacks(IBranchesActions)" />
        /// <seealso cref="BranchesActions.UnregisterCallbacks(IBranchesActions)" />
        public void SetCallbacks(IBranchesActions instance)
        {
            foreach (var item in m_Wrapper.m_BranchesActionsCallbackInterfaces)
                UnregisterCallbacks(item);
            m_Wrapper.m_BranchesActionsCallbackInterfaces.Clear();
            AddCallbacks(instance);
        }
    }
    /// <summary>
    /// Provides a new <see cref="BranchesActions" /> instance referencing this action map.
    /// </summary>
    public BranchesActions @Branches => new BranchesActions(this);
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "Branches" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="BranchesActions.AddCallbacks(IBranchesActions)" />
    /// <seealso cref="BranchesActions.RemoveCallbacks(IBranchesActions)" />
    public interface IBranchesActions
    {
        /// <summary>
